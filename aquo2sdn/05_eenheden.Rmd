...
```{r leesEenheidLijsten, include=FALSE}
...
kableExtra::kable(de, caption = "DDL eenheid codes die niet in de AQUO eenheid lijst voorkomen.") %>%
...
knitr::kable(DDL_SDN_eenheid_auto, caption = "Eenheidcodes uit de DDL die direct vergelijkbaar zijn met de eenheidcodes uit de SDN tabel (veldnaam altlabel).") %>%
  {if(knitr::is_latex_output()) kable_styling(kable_input = ., latex_options = "scale_down") else .}
...
```{r handMappingEenheden}

handmatigeMappingEenheden <- tribble(
  ~Eenheid.Code, ~altlabel, ~opmerking,
  "mg", "", "Grams (UGRM) en Micrograms (UGUG) komt wel voor",
  "n", "", "in BODC altijd gerelateerd aan volume of lengte",
  "n/m2", "#/m^2", "",
  "n/l", "#/l", "",
  "DIMSLS", "", "",
  "graad", "deg", "",
  "oC", "degC", "",
  "/l", "#/l", "",
  "n/hm", "", "#/m komt wel voor",
  "FTU", "", "komt ook niet in AQUO voor",
  "JTU", "", "komt ook niet in AQUO voor",
  "meq/l", "mEquiv/l", "",
  "mHz", "", "Hz komt wel voor",
  "m3/d", "",  "m^3/s komt wel voor",
  "n/ml", "#/ml", "",
  "oD", "",  "duitse graad, komt in mariene metingen niet voor",
  "RFU", "", "komt ook niet in AQUO voor",
  "U", "",   "komt ook niet in AQUO voor",
  "uE" , "",  "waarschijnlijk uE/cm^2/s"
)
...
handmatigeMappingEenheden %>%
  knitr::kable(caption = "Handmatige mapping van overige eenheden.") %>%
   kable_styling(latex_options = "scale_down")
```
...
if(!dir.exists("data/mappings")) dir.create("data/mappings")
write_delim(DDL_SDN_eenheid, file.path("data/mappings", "ddl2sdn_unit.csv"), delim = ";")
