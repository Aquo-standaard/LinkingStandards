...
# from local file
idsw_aquo_map_PO1 <- read_delim("c:/git_checkouts/LinkingStandards/aquo2sdn/data/aquo/Mapping_SDN_P01_2021_12_13.csv", delim = ";")
...
ddl_p01_antijoined %>% distinct(Grootheid.Code) %>% write_delim(file = "data/2map/grootheid_antijoin.csv", delim = ";")
ddl_p01_antijoined %>% distinct(Parameter.Code) %>% write_delim("data/2map/parameter_antijoin.csv", delim = ";")
ddl_p01_antijoined %>% distinct(Compartiment.Code) %>% write_delim("data/2map/compartiment_antijoin.csv", delim = ";")
ddl_p01_antijoined %>% distinct(Hoedanigheid.Code) %>% write_delim("data/2map/hoedanigheid_antijoin.csv", delim = ";")
