...
In eerder werk (Deltares intern) is een mapping gemaakt van deze codes naar BODC op basis van data uit de DDL voor Noordzee en Waddenzee (tabel \@ref(tab:Kwaliteitscodecomparison)). We stellen voor om deze tabel als uitgangspunt te gebruiken. 
