...
De uiteindelijke automatische mapping geeft als resultaat een tabel met `r mappingDim` regels. Dit betekent dat deze metadata uit de DDL al gekoppeld kan worden met de mapping_P01 tabel die eerder gemaakt is. Daarna wordt gekeken naar welke metadata nog niet automatisch gekoppeld kan worden. Dit wordt gedaan door apart naar de verschillende velden, `r metadatavelden` te zoeken. Handmatig wordt er gezocht naar de juiste match voor de ontbrekende metadata velden.
